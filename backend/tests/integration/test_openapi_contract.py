...
EXPECTED_OPERATIONS = {
    ...
    ): "registerCanonicalOutreachTemplateV2",
    (
        "GET",
        "/api/v2/outreach/template-versions/{version_id}",
    ): "getOutreachTemplateVersionV2",
    (
        "POST",
        "/api/v2/activities/{activity_id}/compositions",
    ): "createOutreachCompositionV2",
    (
        "GET",
        "/api/v2/activities/{activity_id}/compositions",
    ): "listOutreachCompositionsV2",
    (
        "GET",
        "/api/v2/outreach/compositions/{composition_id}",
    ): "getOutreachCompositionV2",
    ("PATCH", "/api/v2/outreach/drafts/{draft_id}"): "editOutreachDraftV2",
    ("POST", "/api/v2/outreach/drafts/{draft_id}/refresh"): "refreshOutreachDraftV2",
    ("POST", "/api/v2/outreach/drafts/{draft_id}/retry"): "retryOutreachDraftV2",
    (
        "POST",
        "/api/v2/outreach/compositions/{composition_id}/sender-facts",
    ): "confirmOutreachSenderFactsV2",
    ...
    (
        "GET",
        "/api/v2/discovery/saved-sets/{set_id}/results",
    ): "getCandidateSetResultsV2",
