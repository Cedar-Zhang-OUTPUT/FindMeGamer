...
export function App() {
  ...
  const taskGate=page==='match'||(page==='settings'&&(collectionReturn||recoveryOrigin&&recoveryPage==='match'))?matchGate:navigationGate;
