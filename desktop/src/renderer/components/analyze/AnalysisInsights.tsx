...
export function AnalysisInsights({brief={},analysis={},sourceStatus={}}:{brief?:JsonObject;analysis?:JsonObject;sourceStatus?:JsonObject}){
 ...
 if(!primary.length)return <details className="analysis-more insight-unavailable"><summary><span>Analysis unavailable</span>{sourceStatus.freshness==='stale'&&<span className="status-badge">Previous analysis · stale</span>}</summary><Coverage brief={brief} analysis={analysis} sourceStatus={sourceStatus}/></details>;
 ...
 <details className="analysis-more"><summary>Coverage &amp; unavailable fields</summary><Coverage brief={brief} analysis={analysis} sourceStatus={sourceStatus}/></details>
 </section>;
}
