...
import type { DraftView, SlotValues } from '../../../shared/drafts';
  ...
  return <section className="draft-editor" aria-label="Draft email editor">
    ...
    <div className="draft-editor-layout">
      <div className="draft-editor-mail">
        ...
        {draft.rendered ? <EmailDocument html={draft.rendered.html} title="Saved email preview" /> : <div className="draft-preview-empty" aria-hidden="true"><span/><span/><span/><span/></div>}
      </div>
      <form className="draft-fields" onSubmit={event => { event.preventDefault(); void save(); }}>
