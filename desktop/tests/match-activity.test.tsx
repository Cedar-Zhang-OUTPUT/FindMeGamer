...
afterEach(cleanup);
function setup(match=matchAPIMock()){const api={match} as DesktopBridge;render(<MatchActivity api={api} activityId={activityFixture().id} active onBack={()=>{}} onOpenCreator={()=>{}}/>);return {api,user:userEvent.setup()};}
