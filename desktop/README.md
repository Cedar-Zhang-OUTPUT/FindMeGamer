...
- Preload: typed `connection`, `library`, `creators`, `games`, `match`, `savedSets`, `outreach`, `settings`, `preferences`, `updates`, and `openExternal` business methods. No generic fetch, IPC channel, Node, filesystem or shell access.
